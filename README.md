...
Welcome to my personal toy project—a curated collection of 100 ideas to deepen my understanding and skills in Large Language Models (LLMs). These projects were generated with the help of an LLM (Grok, built by xAI) and thoughtfully organized into 10 categories, each targeting critical competencies for LLM-related roles. From mastering core transformer architectures to exploring advanced applications, optimization techniques, and real-world deployment, this list is my roadmap to becoming a proficient AI practitioner.
...
Below are 100 project ideas organized into 10 categories. Each category hones a key LLM skillset.
